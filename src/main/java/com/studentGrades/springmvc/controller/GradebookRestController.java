...
import com.studentGrades.springmvc.exceptions.StudentOrGradeErrorResponse;
import com.studentGrades.springmvc.exceptions.StudentOrGradeNotFoundException;
...
public class GradebookRestController {
    ...
    public GradebookCollegeStudent studentInformation(@PathVariable int id) {
        ...
        if (!studentService.isStudentNotNull(id)) {
            throw new StudentOrGradeNotFoundException("Student or Grade was not found");
        }
        GradebookCollegeStudent studentEntity = studentService.getGradebookCollegeStudent(id);
    ...
    public GradebookCollegeStudent createGrade(@RequestParam("grade") double grade,
        ...
        if (!studentService.isStudentNotNull(studentId)) {
            throw new StudentOrGradeNotFoundException("Student or Grade was not found");
        }
        ...
        GradebookCollegeStudent studentEntity = studentService.getGradebookCollegeStudent(studentId);
